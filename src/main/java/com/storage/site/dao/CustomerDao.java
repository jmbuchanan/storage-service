...
public class CustomerDao {
    ...
    public int insertCustomer(Customer customer) {
        ...
        params.put("email", customer.getStripeId());
        params.put("password", customer.getPassword());
        params.put("phone_number", customer.getPhoneNumber());
        params.put("first_name", customer.getStripeId());
        ...
        return namedParameterJdbcTemplate.update(INSERT_CUSTOMER, paramSource, keyHolder, new String[] {"id"});
    }
}
